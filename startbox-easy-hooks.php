...
?>
	<textarea id="<?php $args['hook']; ?>" name="sb_easy_hooks_options[<?php echo $args['hook']; ?>]" style="height: 150px; resize: vertical; width: 530px; float: right;"><?php echo htmlentities( $sb_hook_value, ENT_QUOTES, 'UTF-8' ); ?></textarea>
<?php
}
